...
SECRET_KEY = 'django-insecure-fzm8k_#!7((ooz)#lrrs(7g(iy9lu9o5t5i_cr3d_9y46%%=i6'
...
from gitignore.db_connect import connection_info


DB_HOST = connection_info.get("HOST")
DB_NAME = connection_info.get("NAME")
